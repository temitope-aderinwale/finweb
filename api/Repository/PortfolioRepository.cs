...
namespace api.Repository
{
  public class PortfolioRepository : IPortfolioRepository
  {
    ...
    {
      var porfolioModel = await _context.Portfolios.FirstOrDefaultAsync(x => x.AppUserId == appUser.Id && x.Stock.Symbol.ToLower() == symbol.ToLower());
      ...
      _context.Portfolios.Remove(porfolioModel);
      await _context.SaveChangesAsync();
